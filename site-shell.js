...
if (siteHeaderHost) {
  siteHeaderHost.innerHTML = `
    ...
    <nav class="main-nav" aria-label="主要导航">
      <div class="nav-group"><a href="index.html#about">关于作协</a><div class="nav-submenu"><a href="index.html#about">作协简介</a><a href="index.html#council">作协理事会</a></div></div>
  ...
  siteFooterHost.innerHTML = `
    <div class="footer-inner">
      ...
      <div class="footer-columns">
        <section class="footer-col"><h3>资源</h3><nav><a href="index.html#events">活动动态</a><a href="index.html#course">课程</a><a href="index.html#writers">作家专栏</a><a href="index.html#award">文学奖</a><a href="index.html#bookshop">书店</a><a href="index.html#zhongzi">种字网</a></nav></section>
        <section class="footer-col"><h3>协会</h3><nav><a href="index.html#about">作协简介</a><a href="index.html#council">作协理事会</a><a href="index.html#contact">联系我们</a></nav></section>
